...
CREATE TABLE IF NOT EXISTS `api-crm`.`cl_clientes` (
  ...
  `telefono2` VARCHAR(14) NULL COMMENT '',
  `calle` VARCHAR(45) NOT NULL COMMENT '',
  `noexterior` VARCHAR(45) NOT NULL COMMENT '',
  `nointerior` VARCHAR(45) NULL COMMENT '',
  `colonia` VARCHAR(45) NOT NULL COMMENT '',
  `cp` VARCHAR(6) NOT NULL COMMENT '',
  `ciudad` VARCHAR(45) NOT NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `api-crm`.`usr_usuario_fcm_tokens`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `api-crm`.`usr_usuario_fcm_tokens` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
...
-- -----------------------------------------------------
-- Table `api-crm`.`cl_registro_clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `api-crm`.`cl_registro_clientes` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',
  `id_cliente` INT UNSIGNED NOT NULL COMMENT '',
  `id_ejecutivo` INT UNSIGNED NOT NULL COMMENT '',
  `created_at` DATETIME NULL COMMENT '',
  `updated_at` DATETIME NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `cl_registro_clientes_id_cliente` (`id_cliente` ASC)  COMMENT '',
  INDEX `cl_registro_clientes_id_ejecutivo` (`id_ejecutivo` ASC)  COMMENT '',
  CONSTRAINT `cl_registro_clientes_cliente_fk`
    FOREIGN KEY (`id_cliente`)
    REFERENCES `api-crm`.`cl_clientes` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `cl_registro_clientes_ejecutivo_fk`
    FOREIGN KEY (`id_ejecutivo`)
    REFERENCES `api-crm`.`ec_ejecutivos` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
